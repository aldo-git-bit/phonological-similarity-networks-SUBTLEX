...
def create_lexicon():
    ...
    words = []
    sections = ["Word", "IPA","Pyphen", "FREQcount", "Dom Pos", "Syllable-ENG-To-IPA", "Syllable-Pyphen","DIFF"]
    ...
    for i in words:
        ...
        worksheet.write(row,col+2,dic.inserted(i.WORD))
        worksheet.write(row,col+3,i.FREQcount)
        worksheet.write(row,col+4,i.POS)
